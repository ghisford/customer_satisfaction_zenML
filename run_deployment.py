...
def run_deployment(config: str, min_accuracy: float):
    ...
    if deploy:
        continuous_deployment_pipeline(
            data_path="/home/nzima/customer_satisfaction_zenML/data/olist_customer_dataset.csv",
    ...
    # fetch the existing services with the same pipeline name, step name, and model name
    ...
    if existing_services:
        ...
        if service.is_running():
            ...
            print(f"The MLflow prediction server failed to start.\n"
